...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net prime_finder_0_interrupt_number [get_bd_pins axi_pcie_0/MSI_Vector_Num] [get_bd_pins prime_finder_0/interrupt_number]
  connect_bd_net -net prime_finder_0_interrupt_trigger [get_bd_pins axi_pcie_0/INTX_MSI_Request] [get_bd_pins prime_finder_0/interrupt_trigger]
